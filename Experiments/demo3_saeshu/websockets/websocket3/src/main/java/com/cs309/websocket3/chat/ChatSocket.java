...
public class ChatSocket {
  ...
  // method
	...
	private static MessageRepository commonMsgRepo;
   ...
   * easiest.
	...
	@Autowired
	public void setCommonMessageRepository(MessageRepository repo){commonMsgRepo = repo;}
...
//	}
    ...
    // store connecting user information
		...
		sendMessageToPArticularUser(username, getCommonChatHistory());
