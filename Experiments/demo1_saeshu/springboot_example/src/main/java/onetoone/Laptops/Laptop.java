...
/**
 * an entity refers to a real-world object or concept that is represented in code.
 * It could be anything from a person, a place, a thing, or an abstract concept.
 */
@Entity
public class Laptop {
